...
describe('Criteria Desktop Viewport Tests', () => {
  ...
  describe('Rendering a Criteria component', () => {
    describe('When rendering a Criteria component', () => {
      ...
      it('should show the details about the current selected criteria', () => {
  ...
  describe('Clicking on the popover overlay while having an opened criterion that has unpersisted changes', () => {
    describe('Given a Criteria component', () => {
      let info = null
      let onChange = null
